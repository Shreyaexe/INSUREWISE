...
# loading
def load_all_docs():
    file1 = TextLoader('/Users/bishikachhetri/Desktop/chatbot/txtfile/1stsuryajyoti.txt').load()
    file2 = TextLoader('/Users/bishikachhetri/Desktop/chatbot/txtfile/2ndlicnepal.txt').load()
    file3 = TextLoader('/Users/bishikachhetri/Desktop/chatbot/txtfile/3rdsanima.txt').load()
    file4  = TextLoader('/Users/bishikachhetri/Desktop/chatbot/txtfile/4thmettlife.txt').load()
    file5 = TextLoader('/Users/bishikachhetri/Desktop/chatbot/txtfile/5thsunlife.txt').load()
